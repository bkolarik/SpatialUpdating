...
jsPsych.plugins["spatial-updating"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    //var new_html = '<img src="'+trial.stimulus+'" id="jspsych-spatial-updating-stimulus"></img>';
    //var new_html = '<img src="'+trial.stimulus+'" id="jspsych-spatial-updating-stimulus"></img>'
    //var new_html = '<IMG STYLE="position:absolute; TOP:35px; LEFT:170px; WIDTH:80px; HEIGHT:80px" img src="'+trial.stimulus+'" id="jspsych-spatial-updating-stimulus"></img>'
    ...
    // start the response listener
      ...
      if (trial.stimulus_duration !== null) {
        jsPsych.pluginAPI.setTimeout(function() {
          display_element.querySelector('#jspsych-spatial-updating-stimulus').style.visibility = 'hidden';
